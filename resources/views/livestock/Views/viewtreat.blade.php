                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                     <?php 
									 $d=$rw['vet_ID'];
									 $qx="select *from farmer f,animal a,complain c,symptoms s,disease d where
									 a.animal_ID=c.animal_ID and f.F_ID=a.F_ID and a.animal_ID=s.animal_ID and d.dis_ID=s.symp_ID ";

...
$name=$rw['vet_ID'];
$v=$rw['comp_ID'];
$q1="select *from complain c,animal a,treatment t,feedingplan p,food f
WHERE c.comp_ID=t.comp_ID and a.animal_ID=c.animal_ID and t.treat_ID=p.treat_ID and
 f.food_ID=p.food_ID and c.comp_ID=$v";
$qe1=mysqli_query($pdo,$q1) or die(mysqli_error());
$pdf->ln(5);

$pdf->cell(38,8,"Food Name",1,0,'C',0);
$pdf->cell(38,8,"Food Type",1,0,'C',0);
$pdf->cell(38,8,"Duration",1,0,'C',0);
$pdf->cell(38,8,"Quantity",1,0,'C',0);
$pdf->cell(38,8,"Date",1,1,'C',0);

while ($row=mysqli_fetch_array($qe1)){
$pdf->cell(38,8,$row['F_Name'],1,0,'C',0);
$pdf->cell(38,8,$row['type'],1,0,'C',0);
$pdf->cell(38,8,$row['duration'],1,0,'C',0);
$pdf->cell(38,8,$row['quantity'],1,0,'C',0);
